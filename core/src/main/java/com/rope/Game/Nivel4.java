...
public class Nivel4 extends NivelBase implements Screen {
    ...
    private DistanceJoint distanceJoint, distanceJoint2, distanceJoint3;
    ...
    public void show() {
        ...
        leftAnchorDef.position.set(-10, -10);
        ...
        rightAnchorDef.position.set(10, -5);
    ...
    public void manejarVictoria() {
        if (!mostrarCuadroVictoria) {
            ...
            Usuario usuario = Usuario.getUsuarioLogueado();
            if (usuario != null) {
                usuario.marcarNivelComoCompletado(3);
